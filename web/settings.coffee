...
module.exports =
	...
	apis:
		...
		realTime:
			url: "http://real-time:3000"
		contacts:
			url: "http://contacts:3000"
		sixpack:
			url: ""
		references:
	...
	siteUrl : siteUrl = 'http://sharelatex.local'
	...
	httpAuthSiteUrl: 'http://#{httpAuthUser}:#{httpAuthPass}@sharelatex.local'
